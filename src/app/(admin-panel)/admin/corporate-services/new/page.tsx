...
export default function NewCorporateServicePage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold ml-4">Add New Corporate Service</h1>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create a new corporate service to display on your website
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ServiceForm
