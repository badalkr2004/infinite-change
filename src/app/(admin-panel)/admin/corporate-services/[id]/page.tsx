...
export default function EditCorporateServicePage() {
  const params = useParams();
  const [service, setService] = useState<CorporateService | null>(null);
  ...
  const handleSubmit = async (data: ServiceFormValues) => {
    try {
      ...
      router.push("/admin/corporate-services");
      router.refresh();
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold ml-4">Edit Corporate Service</h1>
      </div>
