...
export default function MindfulnessServicesPage() {
  const [services, setServices] = useState<MindfulnessService[]>([]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Mindfulness Services</h1>
        <Button 
          className="bg-black text-white hover:text-black hover:bg-neutral-300  rounded"
          onClick={() => router.push('/admin/mindfulness-services/new')}
        >
      ...
      <Card>
        <CardHeader>
          <CardTitle>Manage Mindfulness Services</CardTitle>
          <CardDescription>
            View, edit and delete mindfulness services for your website
          </CardDescription>
        </CardHeader>
        <CardContent>
          {services.length === 0 ? (
            <div className="text-center py-6 text-muted-foreground">
              No mindfulness services found. Click &quot;Add New Service&quot; to create one.
            </div>
          ) : (
            <Table>
              <TableHeader>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        variant={"admin-outline"}
                          ...
                          onClick={() => router.push(`/admin/mindfulness-services/${service.id}`)}
                        >
