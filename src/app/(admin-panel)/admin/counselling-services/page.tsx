...
export default function CounsellingServicesPage() {
  ...
  const fetchServices = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/counselling-services');
  ...
  const handleDelete = async (id: string) => {
    try {
      const response = await fetch(`/api/admin/counselling-services/${id}`, {
        method: 'DELETE',
      });
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button 
          ...
          onClick={() => router.push('/admin/counselling-services/new')}
        >
      ...
      <Card>
        <CardHeader>
          <CardTitle>Manage Counselling Services</CardTitle>
          <CardDescription>
            View, edit and delete counselling services for your website
          </CardDescription>
        </CardHeader>
        <CardContent>
          {services.length === 0 ? (
            <div className="text-center py-6 text-muted-foreground">
              No counselling services found. Click &quot;Add New Service&quot; to create one.
            </div>
          ) : (
            <Table>
              <TableHeader>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() => router.push(`/admin/counselling-services/${service.id}`)}
                        >
