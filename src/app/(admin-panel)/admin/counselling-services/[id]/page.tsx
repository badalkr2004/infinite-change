...
export default function EditCounsellingServicePage() {
  ...
  const [service, setService] = useState<CounsellingService | null>(null);
  ...
  const handleSubmit = async (data: ServiceFormValues) => {
    try {
      ...
      toast.success('Counselling service updated successfully');
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold ml-4">Edit Counselling Service</h1>
      </div>
